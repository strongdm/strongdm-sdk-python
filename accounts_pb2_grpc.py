  ...
  """
    ...
    """
        self.Create = channel.unary_unary(
            '/v1.Accounts/Create',
            request_serializer=accounts__pb2.AccountCreateRequest.
            SerializeToString,
            response_deserializer=accounts__pb2.AccountCreateResponse.
            FromString,
        )
        self.Get = channel.unary_unary(
            '/v1.Accounts/Get',
            request_serializer=accounts__pb2.AccountGetRequest.
            SerializeToString,
            response_deserializer=accounts__pb2.AccountGetResponse.FromString,
        )
        self.Update = channel.unary_unary(
            '/v1.Accounts/Update',
            request_serializer=accounts__pb2.AccountUpdateRequest.
            SerializeToString,
            response_deserializer=accounts__pb2.AccountUpdateResponse.
            FromString,
        )
        self.Delete = channel.unary_unary(
            '/v1.Accounts/Delete',
            request_serializer=accounts__pb2.AccountDeleteRequest.
            SerializeToString,
            response_deserializer=accounts__pb2.AccountDeleteResponse.
            FromString,
        )
        self.List = channel.unary_unary(
            '/v1.Accounts/List',
            request_serializer=accounts__pb2.AccountListRequest.
            SerializeToString,
...
def add_AccountsServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=accounts__pb2.AccountCreateResponse.
            SerializeToString,
        ),
        'Get':
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=accounts__pb2.AccountGetResponse.
            SerializeToString,
        ),
        'Update':
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=accounts__pb2.AccountUpdateResponse.
            SerializeToString,
        ),
        'Delete':
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=accounts__pb2.AccountDeleteResponse.
            SerializeToString,
        ),
        'List':
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=accounts__pb2.AccountListResponse.
            SerializeToString,
        ),
    }
