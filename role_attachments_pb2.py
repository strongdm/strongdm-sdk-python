...
_ROLEATTACHMENT = _descriptor.Descriptor(
    ...
    enum_types=[],
    serialized_options=_b(
        '\372\370\263\007\022\242\363\263\007\010RoleRole\250\363\263\007\001\222A\237\001*N\n\021A RoleAttachment.\0229https://www.strongdm.com/docs/api/entities#RoleAttachment2M\022K{ \"id\": \"ra-244\", \"composite_role_id\": \"r-111\", \"attached_role_id\":\"r-444\"}'
    ),
    is_extendable=False,
    syntax='proto3',
    extension_ranges=[],
...
_ROLEATTACHMENTS = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\002\025\022\023/v1/roleAttachments'),
        ),
    ])
