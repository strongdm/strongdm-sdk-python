...
field_options = _descriptor.FieldDescriptor(name='field_options',
                                            full_name='v1.field_options',
                                            index=0,
                                            number=1941390,
                                            type=11,
                                            cpp_type=10,
...
message_options = _descriptor.FieldDescriptor(name='message_options',
                                              full_name='v1.message_options',
                                              index=1,
                                              number=1941391,
                                              type=11,
                                              cpp_type=10,
...
oneof_options = _descriptor.FieldDescriptor(name='oneof_options',
                                            full_name='v1.oneof_options',
                                            index=2,
                                            number=1941381,
                                            type=11,
                                            cpp_type=10,
...
service_options = _descriptor.FieldDescriptor(name='service_options',
                                              full_name='v1.service_options',
                                              index=3,
                                              number=1941401,
                                              type=11,
                                              cpp_type=10,
...
_FIELDOPTIONS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(name='name',
                                    full_name='v1.FieldOptions.name',
                                    index=0,
                                    number=1941300,
                                    type=9,
                                    cpp_type=9,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='sql_nullable',
                                    full_name='v1.FieldOptions.sql_nullable',
                                    index=1,
                                    number=1941301,
                                    type=8,
                                    cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='v1.FieldOptions.expose_as_porcelain',
            index=2,
            number=1941302,
            type=8,
            cpp_type=7,
            ...
            serialized_options=None,
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='iterable',
                                    full_name='v1.FieldOptions.iterable',
                                    index=3,
                                    number=1941303,
                                    type=8,
                                    cpp_type=7,
...
_MESSAGEOPTIONS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(name='model_name',
                                    full_name='v1.MessageOptions.model_name',
                                    index=0,
                                    number=1941300,
                                    type=9,
                                    cpp_type=9,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='porcelain',
                                    full_name='v1.MessageOptions.porcelain',
                                    index=1,
                                    number=1941301,
                                    type=8,
                                    cpp_type=7,
        ...
        _descriptor.FieldDescriptor(name='error',
                                    full_name='v1.MessageOptions.error',
                                    index=2,
                                    number=1941302,
                                    type=5,
                                    cpp_type=1,
...
_ONEOFOPTIONS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(name='model_name',
                                    full_name='v1.OneofOptions.model_name',
                                    index=0,
                                    number=1941380,
                                    type=9,
                                    cpp_type=9,
...
_SERVICEOPTIONS = _descriptor.Descriptor(
    ...
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(name='main_noun',
                                    full_name='v1.ServiceOptions.main_noun',
                                    index=0,
                                    number=1941400,
                                    type=9,
                                    cpp_type=9,
...
google_dot_protobuf_dot_descriptor__pb2.OneofOptions.RegisterExtension(
    oneof_options)
