...
_ATHENA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\362\370\263\007\005\260\363\263\007\001\362\370\263\007\t\352\363\263\007\004tags\362\370\263\007\t\362\363\263\007\004Tags\362\370\263\007\"\372\363\263\007\035java.util.Map<String, String>\362\370\263\007\014\202\364\263\007\007TypeMap'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_PAIR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='v1.Pair.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='v1.Pair.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ATHENA.fields_by_name['tags'].message_type = _TAGS
_BIGQUERY.fields_by_name['tags'].message_type = _TAGS
_CASSANDRA.fields_by_name['tags'].message_type = _TAGS
_DRUID.fields_by_name['tags'].message_type = _TAGS
_DYNAMODB.fields_by_name['tags'].message_type = _TAGS
_AMAZONES.fields_by_name['tags'].message_type = _TAGS
_ELASTIC.fields_by_name['tags'].message_type = _TAGS
_HTTPBASICAUTH.fields_by_name['tags'].message_type = _TAGS
_HTTPNOAUTH.fields_by_name['tags'].message_type = _TAGS
_HTTPAUTH.fields_by_name['tags'].message_type = _TAGS
_KUBERNETES.fields_by_name['tags'].message_type = _TAGS
_KUBERNETESBASICAUTH.fields_by_name['tags'].message_type = _TAGS
_KUBERNETESSERVICEACCOUNT.fields_by_name['tags'].message_type = _TAGS
_AMAZONEKS.fields_by_name['tags'].message_type = _TAGS
_GOOGLEGKE.fields_by_name['tags'].message_type = _TAGS
_AKS.fields_by_name['tags'].message_type = _TAGS
_AKSBASICAUTH.fields_by_name['tags'].message_type = _TAGS
_AKSSERVICEACCOUNT.fields_by_name['tags'].message_type = _TAGS
_MEMCACHED.fields_by_name['tags'].message_type = _TAGS
_MONGOLEGACYHOST.fields_by_name['tags'].message_type = _TAGS
_MONGOLEGACYREPLICASET.fields_by_name['tags'].message_type = _TAGS
_MONGOHOST.fields_by_name['tags'].message_type = _TAGS
_MONGOREPLICASET.fields_by_name['tags'].message_type = _TAGS
_MYSQL.fields_by_name['tags'].message_type = _TAGS
_AURORAMYSQL.fields_by_name['tags'].message_type = _TAGS
_CLUSTRIX.fields_by_name['tags'].message_type = _TAGS
_MARIA.fields_by_name['tags'].message_type = _TAGS
_MEMSQL.fields_by_name['tags'].message_type = _TAGS
_ORACLE.fields_by_name['tags'].message_type = _TAGS
_POSTGRES.fields_by_name['tags'].message_type = _TAGS
_AURORAPOSTGRES.fields_by_name['tags'].message_type = _TAGS
_GREENPLUM.fields_by_name['tags'].message_type = _TAGS
_COCKROACH.fields_by_name['tags'].message_type = _TAGS
_REDSHIFT.fields_by_name['tags'].message_type = _TAGS
_PRESTO.fields_by_name['tags'].message_type = _TAGS
_RDP.fields_by_name['tags'].message_type = _TAGS
_REDIS.fields_by_name['tags'].message_type = _TAGS
_ELASTICACHEREDIS.fields_by_name['tags'].message_type = _TAGS
_SNOWFLAKE.fields_by_name['tags'].message_type = _TAGS
_SQLSERVER.fields_by_name['tags'].message_type = _TAGS
_SSH.fields_by_name['tags'].message_type = _TAGS
_SYBASE.fields_by_name['tags'].message_type = _TAGS
_SYBASEIQ.fields_by_name['tags'].message_type = _TAGS
_TERADATA.fields_by_name['tags'].message_type = _TAGS
_TAGS.fields_by_name['pairs'].message_type = _PAIR
