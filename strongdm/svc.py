...
class AccountAttachments:
    ...
    def create(self,
        ...
        if account_attachment is not None:
            req.account_attachment.CopyFrom(plumbing.account_attachment_to_plumbing(account_attachment))
        if options is not None:
            req.options.CopyFrom(plumbing.account_attachment_create_options_to_plumbing(options))
        tries = 0
        ...
        def generator(svc, req):
            ...
            while True:
                ...
                for plumbing_item in plumbing_response.account_attachments:
                    yield plumbing.account_attachment_to_porcelain(plumbing_item)
...
class AccountGrants:
    ...
    def create(self,
        ...
        if account_grant is not None:
            req.account_grant.CopyFrom(plumbing.account_grant_to_plumbing(account_grant))
        tries = 0
        plumbing_response = None
        while True:
            try:
...
class RoleAttachments:
    ...
    def create(self,
        ...
        if role_attachment is not None:
            req.role_attachment.CopyFrom(plumbing.role_attachment_to_plumbing(role_attachment))
        tries = 0
        plumbing_response = None
        while True:
            try:
...
class RoleGrants:
    ...
    def create(self,
        ...
        if role_grant is not None:
            req.role_grant.CopyFrom(plumbing.role_grant_to_plumbing(role_grant))
        tries = 0
        plumbing_response = None
        while True:
            try:
